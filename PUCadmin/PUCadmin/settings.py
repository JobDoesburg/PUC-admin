"""
Django settings for PUCadmin project.
...
SAML2_AUTH = {
    ...
    "ENTITY_ID": "localhost:8000",  # Populates the Issuer element in authn request
    "NAME_ID_FORMAT": "uid",  # Sets the Format property of authn NameIDPolicy element
    "USE_JWT": False,  # Set this to True if you are running a Single Page Application (SPA) with Django Rest Framework (DRF), and are using JWT authentication to authorize client users
    "FRONTEND_URL": "localhost:8000",  # Redirect URL for the client if you are using JWT auth with DRF. See explanation below
}
