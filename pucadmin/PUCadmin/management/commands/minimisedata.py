...
def minimise_data():
    ...
    minimised += competitions.management.commands.minimisecompetitionsdata.minimise_data()
    return minimised
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"Successfully minimised {minimised} objects"))