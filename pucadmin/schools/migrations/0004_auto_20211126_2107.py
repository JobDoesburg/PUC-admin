...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='school',
            name='bg_id',
            field=models.CharField(default=0, max_length=5, verbose_name='Bevoegd Gezag id'),
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, max_length=10, null=True, verbose_name='house number (correspondence)'),
        ),
        migrations.AddField(
            model_name='school',
            name='correspondence_street',
            field=models.CharField(blank=True, max_length=100, null=True, verbose_name='street (correspondence)'),
        ),
        migrations.AddField(
            model_name='school',
            name='correspondence_town',
            field=models.CharField(blank=True, max_length=50, null=True, verbose_name='town (correspondence)'),
        ),
        migrations.AddField(
            model_name='school',
            name='correspondence_zip',
            field=models.CharField(blank=True, max_length=7, null=True, validators=[django.core.validators.RegexValidator(message="Enter zip code in this format: '1234 AB'", regex='^[1-9][0-9]{3} (?!SA|SD|SS)[A-Z]{2}')], verbose_name='zip'),
        ),
        migrations.AddField(
            model_name='school',
            name='dissolved',
